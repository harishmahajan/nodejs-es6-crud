...
function () {
  ...
  _regenerator.default.mark(function _callee(req, res) {
    var query, pageSize, page, totalCount, tempCount, datas, userData, _iteratorNormalCompletion, _didIteratorError, _iteratorError, _iterator, _step, user, responseData;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            totalCount = 0, tempCount = 0;
            datas = [];
            console.log(pageSize);
            console.log(page);
            _context.next = 9;
            return _userModel.default.countDocuments(query, function (err, count) {
              totalCount = count;
            });
          ...
          case 9:
            ...
            _context.next = 12;
            return _userModel.default.find().skip(page).limit(pageSize);
          ...
          case 12:
            ...
            for (_iterator = userData[Symbol.iterator](); !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
              user = _step.value;
              datas.push({
                _id: user._id,
          ...
          case 32:
            ...
            res.json(_responseHelper.default.SuccessResponse(200, _messageParser.default.alertmessage['tblUser'].listsuccess, responseData));
