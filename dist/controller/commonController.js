...
var db = new MongoClient.connect(url, function (err, client) {
  db = client.db(database);
}); //var ObjectId = require('mongodb').ObjectID;

var jwt = require("jsonwebtoken");

var messageParser = require("../helpers/messageParser"); // Api for Insert Document
...
function () {
  ...
  _regenerator.default.mark(function _callee(req, res) {
    var query, pageSize, page, sort, totalRecords, totalPages;
      ...
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            ...
            query = {};
            pageSize = parseInt(req.query.rows);
            page = parseInt(req.query.page);
            sort = req.query.sord == "ASC" ? 1 : -1;
            totalRecords = 0;
            totalPages = 0;
            ...
            db.collection("test").find({}).skip(page).limit(pageSize).sort({
              'ShipName': sort
            }).toArray(function (err, result) {
              var obj = {
                total: totalPages,
